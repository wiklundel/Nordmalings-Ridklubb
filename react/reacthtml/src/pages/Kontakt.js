                            ...
                            <form action="action_page" method="POST">
                                <div className="formMargin">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="f-lname" name="f-lname" placeholder="För- och efternamn" required autoComplete='name'/>
                                    </div>
                                
                                    <div>
                                        <label htmlFor="tel"></label>
                                        <input type="tel" id="tel" name="tel" placeholder="Telefonnummer" required autoComplete='tel'/>
                                    </div>

                                    <div>
                                        <label htmlFor="email"></label>
                                        <input type="email" id="email" name="email" placeholder="E-mailadress" required autoComplete='email'/>
                                    </div>
